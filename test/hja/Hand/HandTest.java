...
class HandTest {
	...
	private static final Hand pair2 = new Pair(new ArrayList<>(Arrays.asList(ace, king, king, seven, three)));
	
	private static final Hand twopair1 = new TwoPair(new ArrayList<>(Arrays.asList(ace, ace, seven, seven, two)));
	private static final Hand twopair2 = new TwoPair(new ArrayList<>(Arrays.asList(ace, king, king, three, three)));
	
	private static final Hand threeof1 = new ThreeOfAKind(new ArrayList<>(Arrays.asList(ace, ace, ace, three, two)));
	private static final Hand threeof2 = new ThreeOfAKind(new ArrayList<>(Arrays.asList(ace, king, king, king, three)));
	...
	private static final Hand full2 = new FullHouse(new ArrayList<>(Arrays.asList(queen, queen, ten, ten, ten)));
	
	private static final Hand fourof1 = new FourOfAKind(new ArrayList<>(Arrays.asList(ace, ace, ace, ace, five)));
	private static final Hand fourof2 = new FourOfAKind(new ArrayList<>(Arrays.asList(ten, six, six, six, six)));
